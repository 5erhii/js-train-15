...
function calculateCircleArea(radius) {
  ...
  if (!typeof radius == "number") {
    ...
    console.log("Параметр повинен бути числом.");
...
function findMinMax(numbers) {
  ...
  if (!typeof numbers == "Array") {
    ...
    console.log("Параметр повинен бути масивом.");
...
function sumPositiveNumbers(numbers) {
  ...
  if (!typeof numbers == "Array") {
    console.log("Параметр повинен бути масивом чисел.");
    // Повертаємо null, що свідчить про неможливість обробки вхідних даних.
    return null;
  }
...
function estimateInvestment(principal, interestRate, years) {
  ...
  let estimateSum = principal * Math.pow((1 + interestRate), years);
  // Округляємо ії до найближчого цілого
  estimateSum = Math.round(estimateSum);
...
function isTotalPriceExceedsMaxPrice(products, maxPrice) {
  ...
  // Перевіряємо, чи аргумент maxPrice є числом.
    ...
    console.log("Параметр повинен бутим числом.");
    // Повертаємо null, що свідчить про неможливість обробки вхідних даних.
    return null;
  }
